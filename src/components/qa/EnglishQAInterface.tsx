        ...
        <div className="bg-gradient-to-br from-gray-900/90 to-indigo-900/80 rounded-2xl p-6 backdrop-blur border-2 border-indigo-500/50">
          ...
          <div className="space-y-3">
            {topPerformers.map((player, i) => (
              <div key={i} className={`flex items-center gap-4 p-4 rounded-xl transition-all hover:scale-102 ${i === 0 ? 'bg-gradient-to-r from-yellow-500/30 to-amber-500/30 border-2 border-yellow-400/60 shadow-lg shadow-yellow-500/30' :
                ...
                <div className={`w-12 h-12 rounded-lg flex items-center justify-center font-bold text-xl shadow-lg ${i === 0 ? 'bg-gradient-to-br from-yellow-400 to-amber-500 text-black' :
